...
require get_template_directory() . '/blocks/recent-posts.php';
require get_template_directory() . '/blocks/questions-toggle.php';
require get_template_directory() . '/blocks/hero.php';
require get_template_directory() . '/blocks/login.php';
require get_template_directory() . '/blocks/main-movie.php';
require get_template_directory() . '/blocks/category-list.php';
require get_template_directory() . '/blocks/recent-post-page.php';
require get_template_directory() . '/blocks/most-viewed.php';
require get_template_directory() . '/blocks/category-post-filter.php';
require get_template_directory() . '/blocks/press-releases.php';
require get_template_directory() . '/blocks/change-password.php';
